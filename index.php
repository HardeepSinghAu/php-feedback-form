...
<!-- we can use include or require, both will work. However if there is an error, require stops the whole app whereas include shows an error and then shows the rest of the app -->
<?php
// Set vars to empty values, below is a short cut to setting all to an empty string  
$name = $email = $body = '';
...
?>
    ...
    <p class="lead text-center">Leave feedback for Hardeep Singh</p>
